...
const menuItems = [
  ...
  { name: "Thời khoá biểu học kỳ", path: "time-tables-semeters", icon: FiCalendar },
  { name: "Môn đã đăng ký", path: "/courses", icon: FiCalendar },
  { name: "Xem điểm", path: "/scores", icon: FiCalendar },
];
